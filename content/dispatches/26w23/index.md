...
Finally, the clip is made of a flat blade instead of a round wire, but it has the perfect amount of springiness. In the end, apart from the refill, the Zento Signature has nothing in common with the basic Zento. The 0.38 mm tip wouldn’t have been my first choice, but it was my only choice[^2].
...
[^1]: Did you know that the distance between your extended thumb and forefinger is called a purlicue? I didn’t.
[^2]: My <s>drug dealer</s> brother-in-law had to scour dozens of stationery shops in three Japanese cities before finding a place that still had a few models in stock.