---
title: "Cerise: my single pickup Fender Stratocaster"
...
But first, i had to remember what i actually wanted to do. I’d bought two [CTS volume pots](https://www.stewmac.com/electronics/components-and-parts/potentiometers/cts-control-pots/?srsltid=AfmBOoq9KG4B5yOBQmHeyJmYMS8r6GxOEimPKRzcLdr6gkFqMMsyJspH): a 250 kΩ, which is standard for single-coil pickups, and a 500 kΩ, which is more commonly associated with humbuckers. When i found [a TBX tone control](https://www.fender.com/products/tbx-tone-control-potentiometer-kit) at the bottom of my parts bin, it suddenly made sense. I’d wanted to emulate Eric Clapton’s soloing tone on the cheap.
...
{{< gallery caption="Images Anthony Nelzin-Santos." >}}
cerise-my-single-pickup-fender-stratocaster-1-1.jpg
cerise-my-single-pickup-fender-stratocaster-2.jpg

cerise-my-single-pickup-fender-stratocaster-4.jpg
cerise-my-single-pickup-fender-stratocaster-3.jpg
{{< /gallery >}}

The noiseless pickup is pretty hot for a single-coil, so the 500 kΩ volume pot should be a great match. Seymour Duncan doesn’t have [a wiring diagram](https://www.seymourduncan.com/resources/pickup/wiring-diagrams) for a “single-coil one-volume one-TBX no-selector” guitar, which is anything you have to know about this weird idea, but i found salvation [on the *Strat Talk* forum](https://strat-talk.com/threads/tbx-master-tone-and-separate-blend-pot-diagram-needed.513742/).
